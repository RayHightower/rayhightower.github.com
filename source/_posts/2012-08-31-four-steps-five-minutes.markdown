...
####Which Customers?<a href="{filedir_1}lifecycle.png" onclick="window.open('{filedir_1}lifecycle.png','popup','width=770,height=548,scrollbars=no,resizable=yes,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img src="{filedir_1}lifecycle_thumb.png" border="0" alt="image" name="image" class="right" width="195" height="137" /></a>
